...
class Checkout:
    ...
    def confirmorder(self):
        ...
        print("The total cost of these items is: $" + str(total_value))
    ...
    def add_to_order(self):
        ...
        order_number = 1
        for x in result:
            query2 = "INSERT INTO Order_History (username, order_number, item_id, item_count) " \
                     "VALUES (%s, %s, %s, %s)"
            data2 = (x[0], order_number, x[1], x[2])
    ...
    def view_order_history(self):
        ...
        query = "SELECT * FROM Order_History WHERE username=%s"
        data = (self.username, )
        ...
        for x in result:
            print("Order:", x[1], "Item_ID:", x[2], "Item_Count:", x[3])
        print()
